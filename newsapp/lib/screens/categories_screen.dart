  ...
  Widget build(BuildContext context) {
    List<CategoryItem> item = [
      CategoryItem('BUSINESS',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Business');
      }),
      CategoryItem('SPORTS',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Sports');
      }),
      ...
      CategoryItem('TECHNOLOGY',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Tecnology');
      }),
      CategoryItem('TESLA',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Tesla');
      }),
      CategoryItem('APPLE',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Apple');
      }),
      CategoryItem('Cricket',
          'https://images.unsplash.com/photo-1590134586486-1084d699b732?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1412&q=80',
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Cricket');
      }),
      CategoryItem('Global News',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Global');
      }),
      CategoryItem('HEALTH',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Health');
      }),
      CategoryItem('SCIENCE',
          ...
          () {
        Navigator.pushNamed(context, Items.routeName, arguments: 'Science');
      }),
    ];
    return Scaffold(
